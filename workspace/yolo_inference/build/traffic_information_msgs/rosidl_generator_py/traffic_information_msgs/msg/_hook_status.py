...
class Metaclass_HookStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('traffic_information_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'traffic_information_msgs.msg.HookStatus')
            logger.debug(
...
class HookStatus(metaclass=Metaclass_HookStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.is_hooked = kwargs.get('is_hooked', bool())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.is_hooked != other.is_hooked:
            return False
        return True
    ...
    @builtins.property
    def is_hooked(self):
        """Message field 'is_hooked'."""
        return self._is_hooked

    @is_hooked.setter
    def is_hooked(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'is_hooked' field must be of type 'bool'"
